	...
	public partial class PluginCore
	{
    	...
    	public void RenderButlerHud()
    	{
    		try
    		{
    			...
    			ButlerHudLayout.AddControl(ButlerHudTabView, new Rectangle(0,0,GearButlerSettings.ButlerHudWidth,GearButlerSettings.ButlerHudHeight));
        ...
        private void ButlerHudView_Resize(object sender, System.EventArgs e)
        {
            try
            {
                bool bw = Math.Abs(ButlerHudView.Width - GearButlerSettings.ButlerHudWidth) > 20;
                bool bh = Math.Abs(ButlerHudView.Height - GearButlerSettings.ButlerHudHeight) > 20;
                if (bh || bw)
                {
