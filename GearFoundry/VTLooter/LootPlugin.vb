...
Public Class LootPlugin
	...
	Private mAlincoBase As AlincoVVS.PluginCore
	Private mAlincoBase2 As Decal.Adapter.Wrappers.PluginHost
    ...
    Private Sub TryGetAlincoInstance()
        ...
        Try
            mAlincoBase2 = AlincoVVS.Globals.Host

            If mAlincoBase2 IsNot Nothing Then
                mAlincoLoaded = True
            End If
            ...
            Select Case item.ObjectClass
                Case ObjectClass.MissileWeapon
                    ...
                    If t = 1 OrElse t = 2 OrElse t = 4 Then
                        Return True
                    End If
                Case uTank2.LootPlugins.ObjectClass.Gem, uTank2.LootPlugins.ObjectClass.Armor, uTank2.LootPlugins.ObjectClass.Clothing, uTank2.LootPlugins.ObjectClass.Jewelry, uTank2.LootPlugins.ObjectClass.MeleeWeapon, uTank2.LootPlugins.ObjectClass.MissileWeapon, uTank2.LootPlugins.ObjectClass.WandStaffOrb
                    Return True
            End Select
        Catch ex As Exception
